...
class WeChatBot():
    ...
    def send_massage(self, agentid, title, description, touser='@all', toparty='@all', totag='@all', url="blog.jimmyisme.top"):
        body = {
            "touser" : touser,
            "toparty" : toparty,
            "totag" : totag,
        ...
        try:
            res = requests.post(post_url, json=body,timeout=10).json()
